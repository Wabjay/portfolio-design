...
import styles from "./Companies/Resume2.module.css";
      ...
      <div className={styles.details}>
        ...
        {projectList.map((project, index) => (
         <li className={`${styles.top_role} list-none`} key={index}>
          <div className="group relative flex flex-col gap-4 pb-1 transition-all sm:flex-row sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
